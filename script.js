...
$(document).ready(function(){
	...
	wm.list[wm.list.length] = new JSWindow(200,200, 300, 100, '<img src="2.jpg">');
	...
	t_graph.add(wm.list[0], wm.list[wm.list.length-1], 'v');
	wm.list[wm.list.length] = new JSWindow(200,200, 100, 100, '<img src="4.jpg">' );
	t_graph.add(wm.list[2], wm.list[wm.list.length-1], 'h');
	wm.list[wm.list.length] = new JSWindow(200,200, 300, 100, '<img src="5.jpg">');
	t_graph.add(wm.list[2], wm.list[wm.list.length-1], 'h');
